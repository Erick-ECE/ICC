...
public class TestEstudiante {
    ...
    @Test public void testEquals() {
        ...
        String otroNombre = String.valueOf(random.nextInt());
        int otraCuenta = random.nextInt(10000000);
        double otroPromedio = random.nextDouble() * 10.0;
        int otraEdad = random.nextInt(50);
