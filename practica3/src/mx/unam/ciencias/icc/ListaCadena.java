...
public class ListaCadena {
    ...
    public void elimina(String elemento) {
        if (contiene(elemento)==true) {
            if (elemento==cabeza.elemento) {
                eliminaPrimero();
                iterador=cabeza;
            }
            else if (elemento==rabo.elemento) {
                eliminaUltimo();
                iterador=cabeza;
            }
            ...
            buscanodo(elemento).siguiente.anterior=buscanodo(elemento).anterior;
            buscanodo(elemento).anterior.siguiente=buscanodo(elemento).siguiente;
            longitud --;
            iterador=cabeza;
           } 
    ...
    private ListaCadena reversa(ListaCadena l,Nodo n){
        if (n==null) {
            return l;
        }
    ...
    public ListaCadena copia() {
         ...
         return copia(x,cabeza);
    }

    private ListaCadena copia(ListaCadena l,Nodo n){
        if(n==null)
            return l;
    ...
    public String get(int i) {
        return get(0,i,cabeza);
    }

    private String get(int j,int i,Nodo n){
        if (n==null) {
            return null;
        }
        if (i==j) {
     ...
     return get(j+=1,i,n=n.siguiente);
    }
    ...
    public int indiceDe(String elemento) {
        return indiceDe(0,elemento,cabeza);
       }

       private int indiceDe(int j,String elemento,Nodo n){
        if (n==null) {
            return -1;
        }
        ...
        return indiceDe(j+=1,elemento,n.siguiente);
       }
    ...
    private Nodo buscanodo(String elemento){
        return buscanodo(elemento,cabeza);
    }

    private Nodo buscanodo(String elemento,Nodo n){
        if (n==null) {
            return  null;
        }
        if (n.elemento.equals(elemento)) {
